...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <br>
        <a class="navbar-brand" href=""><h1 class="display-6">HOTEL ETAHAM</h1></a>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <p class="lead">Kami menyediakan Pelayanan yang berkualitas dengan jaminan Kenyamanan penuh.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div class="card mb-3">
                    <img src="hotel.JPG" width="150" height="180" class="card-img-top " alt="Layanan 1">
                    <div class="card-body">
                      
                          <a class="nav-link" href="seluruh.php">Seluruh Kamar</a>
            ...
            <div class="col-md-3">
                <div class="card mb-3">
                    <img src="vip.JPEG" width="150" height="180" class="card-img-top " alt="Layanan 1">
                    <div class="card-body">
                          <a class="nav-link" href="vip.php">Kamar VIP</a>
            ...
            <div class="col-md-3">
                <div class="card mb-3">
                    <img src="reguler.JPG" width="150" height="180" class="card-img-top" alt="Layanan 2">
                    <div class="card-body">
                        <a class="nav-link" href="reguler.php">Kamar Reguler</a>
                    </div>
                </div>
            </div>
