...
<?php
    ...
    $result = pg_query($cn,"select * from tb_kamar order by harga_kamar ASC");
?>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <img src="hotel.JPG" width="300px" height="150px">
            <a class="display-4">KAMAR HOTEL ETAHAM</a><hr class="bg-dark">
        </div>
    </div>

       <table border="1" align="center" width="1000x" height="500pxx" bgcolor="#ccc">
        <tr>
            <th width="250x" height="50pxx" bgcolor="gray">Nomor Kamar</th>
            <th width="250x" height="50pxx" bgcolor="gray">Harga Kamar</th>
            <th colspan="5" bgcolor="gray">Jenis Kamar</th>
        </tr>
<?php
