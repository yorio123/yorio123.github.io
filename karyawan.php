<?php
    ...
    $result = pg_query($cn,"select * from tb_karyawan order by nama_karyawan ASC");
?>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <img src="karyawanikon.JPEG" width="200px" height="150px">
            <a class="display-4">DATA KARYAWAN HOTEL ETAHAM</a><hr class="bg-dark">
        </div>
    </div>
<table border="2" align="center" width="80%" height="500pxx" bgcolor="#ccc" >
        <tr>
            <th width="250x" height="50pxx" bgcolor="gray">ID Karyawan</th>
            ...
            <th width="250x" height="50pxx" bgcolor="gray">Posisi</th>
...
<?php
    ...
    while ($row = pg_fetch_object($result)) 
    {
        ...
        <tr>    
            ...
            <td>$row->posisi</td>
            <td>$row->jenis_kelamin_karyawan</td>           
        </tr>
        ";  
    }
