...
<?php
    ...
    $result = pg_query($cn,"select * from tb_vip order by no_kamar_vip ASC");
?>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <img src="vip.JPEG" width="300px" height="150px">
            <a class="display-4">KAMAR VIP HOTEL ETAHAM</a><hr class="bg-dark"><br><br>
    </div>
