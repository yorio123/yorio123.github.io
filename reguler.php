...
<?php
    ...
    $result = pg_query($cn,"select * from tb_reguler order by no_kamar_reguler ASC");
?>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <img src="reguler.JPG" width="300px" height="150px">
            <a class="display-4">KAMAR REGULER HOTEL ETAHAM</a><hr class="bg-dark">
        </div>
    </div>
  ...
  <table border="1" align="center" width="1000x" height="500pxx" bgcolor="#ccc">
        <tr>
            ...
            <th colspan="5" bgcolor="gray">Harga Kamar</th>
        </tr>
<?php
